...
\usepackage{todonotes}
%\newcommand{\note}[2][]
%{\todo[color=cdblue!10, #1]{#2}}

\usepackage{marginnote}
\renewcommand*{\marginfont}{\tiny\osfamily}
\newcommand{\note}[1]{\marginnote{\colorbox{cdblue!20}{\parbox{1cm}{#1}}}}
...
%
%\include{numerische-quadratur}
%
%\include{lineare-gleichungssysteme}
%
%\include{kondition}
%
%\include{nichtlineare-gleichungen}
%
%\include{nichtlineare-ausgleichsprobleme}
%
%\include{optimierung}
%
%\include{iterative-duenne-loeser}
%
%\include{direkte-duenne-loeser}

%\include{anfangswertprobleme}

\include{steife-differentialgleichungen}

\include{hamilton-systeme}
