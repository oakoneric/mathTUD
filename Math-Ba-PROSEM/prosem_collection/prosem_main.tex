...
\begin{document}
    ...
    \include{prosem_1_johann_optimalitaet}
    \include{prosem_2_eric_konvexeFkt}
    \include{prosem_3_friedemann_monotonie}
    \include{prosem_4_klemens_definitheit}
    \stepcounter{chapter}
    \include{prosem_6_robert_abstiegsverfahren}
    \include{prosem_7_jonathan_abstiegsverfahren}
    \include{prosem_8_lars_schrittweitenstrategien}
    \include{prosem_9_michael_schrittweitenalgorithmen}
    \include{prosem_10_ducanh_gradientenverfahren}
